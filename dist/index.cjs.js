...
var Icon$1h = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 110.55 110.55" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "75.08,64.38 55.29,84.12 35.54,64.4 24.12,75.79 55.31,106.95 66.73,95.55 66.71,95.53 86.49,75.78 \n                    " }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "19.62,60.09 14.01,65.69 19.57,71.24 25.18,65.64 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "9.87,50.34 4.26,55.94 9.81,61.49 15.42,55.9 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "25.23,46.11 19.68,40.56 14.07,46.15 19.62,51.7 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "29.41,61.48 35.02,55.88 29.46,50.33 23.85,55.93 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "85.3,65.88 90.86,71.43 96.47,65.83 90.91,60.28 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "75.54,56.13 81.1,61.68 86.71,56.08 81.15,50.53 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "90.91,51.89 96.52,46.29 90.96,40.74 85.35,46.34 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "100.75,50.52 95.14,56.12 100.69,61.67 106.3,56.07 \t\t\t" }),
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("text", { transform: "matrix(1.0018 0 0 1 42.3044 66.9701)", fill: "#5FFF71", fontFamily: "aAtmospheric", fontSize: "29.5px" }, "D")),
                    React__default['default'].createElement("polygon", { fill: "#5FFF71", points: "75.08,47.46 55.29,27.72 35.54,47.45 24.12,36.05 55.31,4.9 66.73,16.29 66.71,16.32 86.49,36.06 \n                    " }))))));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 107" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "75.3,62.1 55.51,81.84 35.76,62.12 24.34,73.51 55.53,104.67 66.95,93.27 66.93,93.25 86.71,73.5 \n                    " }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "19.84,57.81 14.23,63.41 19.79,68.96 25.4,63.36 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "10.09,48.06 4.48,53.66 10.03,59.21 15.64,53.62 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "25.45,43.83 19.9,38.28 14.29,43.87 19.84,49.42 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "29.63,59.2 35.24,53.6 29.68,48.05 24.07,53.65 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "85.52,63.6 91.08,69.15 96.69,63.55 91.13,58 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "75.76,53.85 81.32,59.4 86.93,53.8 81.37,48.25 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "91.13,49.61 96.74,44.01 91.18,38.46 85.57,44.06 \t\t\t" }),
                    React__default['default'].createElement("polygon", { fill: wrapColor, points: "100.97,48.24 95.36,53.84 100.91,59.39 106.52,53.79 \t\t\t" }),
                    React__default['default'].createElement("g", null,
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://defiswap.app/swap?outputCurrency=0x1892A5618234Afd97Fd9759a690b43426BfD1B30", target: "_blank" },
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://defiswap.app/swap?outputCurrency=0x1892A5618234Afd97Fd9759a690b43426BfD1B30", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};

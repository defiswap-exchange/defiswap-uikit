...
var Icon$1h = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 110.55 110.55" }, props),
        React__default.createElement("g", null,
            React__default.createElement("g", null,
                React__default.createElement("g", null,
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "75.08,64.38 55.29,84.12 35.54,64.4 24.12,75.79 55.31,106.95 66.73,95.55 66.71,95.53 86.49,75.78 \n                    " }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "19.62,60.09 14.01,65.69 19.57,71.24 25.18,65.64 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "9.87,50.34 4.26,55.94 9.81,61.49 15.42,55.9 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "25.23,46.11 19.68,40.56 14.07,46.15 19.62,51.7 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "29.41,61.48 35.02,55.88 29.46,50.33 23.85,55.93 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "85.3,65.88 90.86,71.43 96.47,65.83 90.91,60.28 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "75.54,56.13 81.1,61.68 86.71,56.08 81.15,50.53 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "90.91,51.89 96.52,46.29 90.96,40.74 85.35,46.34 \t\t\t" }),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "100.75,50.52 95.14,56.12 100.69,61.67 106.3,56.07 \t\t\t" }),
                    React__default.createElement("g", null,
                        React__default.createElement("text", { transform: "matrix(1.0018 0 0 1 42.3044 66.9701)", fill: "#5FFF71", fontFamily: "aAtmospheric", fontSize: "29.5px" }, "D")),
                    React__default.createElement("polygon", { fill: "#5FFF71", points: "75.08,47.46 55.29,27.72 35.54,47.45 24.12,36.05 55.31,4.9 66.73,16.29 66.71,16.32 86.49,36.06 \n                    " }))))));
};
...
var Logo$2 = function (_a) {
    ...
    var wrapColor = isDark ? "#5FFF71" : "#3B9863";
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 512 107" }, props),
        React__default.createElement("g", null,
            React__default.createElement("g", null,
                React__default.createElement("g", null,
                    React__default.createElement("polygon", { fill: wrapColor, points: "75.3,62.1 55.51,81.84 35.76,62.12 24.34,73.51 55.53,104.67 66.95,93.27 66.93,93.25 86.71,73.5 \n                    " }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "19.84,57.81 14.23,63.41 19.79,68.96 25.4,63.36 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "10.09,48.06 4.48,53.66 10.03,59.21 15.64,53.62 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "25.45,43.83 19.9,38.28 14.29,43.87 19.84,49.42 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "29.63,59.2 35.24,53.6 29.68,48.05 24.07,53.65 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "85.52,63.6 91.08,69.15 96.69,63.55 91.13,58 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "75.76,53.85 81.32,59.4 86.93,53.8 81.37,48.25 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "91.13,49.61 96.74,44.01 91.18,38.46 85.57,44.06 \t\t\t" }),
                    React__default.createElement("polygon", { fill: wrapColor, points: "100.97,48.24 95.36,53.84 100.91,59.39 106.52,53.79 \t\t\t" }),
                    React__default.createElement("g", null,
                        React__default.createElement("text", { transform: "matrix(1.0018 0 0 1 42.5288 64.6945)", fill: wrapColor, fontFamily: "aAtmospheric", fontSize: "29.5px" }, "D")),
                    React__default.createElement("polygon", { fill: wrapColor, points: "75.3,45.18 55.51,25.44 35.76,45.17 24.34,33.77 55.53,2.62 66.95,14.01 66.93,14.04 86.71,33.78 \n                    " })),
                React__default.createElement("g", { enableBackground: "new" },
                    React__default.createElement("path", { fill: textColor, d: "M142.2,46.4l10-2.7v20.6h15.7c3,0,5.3-1.7,6.9-5c1-2.1,1.5-4.6,1.5-7.3c0-4.1-1-7.3-3.1-9.5     c-1.4-1.5-3.2-2.3-5.3-2.3h-25.7l2.7-8.9h24.2c5.7,0,10.2,2.4,13.6,7.2c2.8,4,4.2,8.7,4.2,14.2c0,5.8-1.5,10.6-4.6,14.4     c-3.3,4-7.6,6.1-13.1,6.1h-26.9V46.4z" }),
                    React__default.createElement("path", { fill: textColor, d: "M201.8,56.7v7.5h30.6l-2.7,8.9h-37.9V31.2h40.6l-2.7,8.9h-27.9v7.6h26v8.9H201.8z" }),
                    React__default.createElement("path", { fill: textColor, d: "M248.4,56.7v16.5h-10V31.2h40l-2.7,8.9h-27.3v7.6h25.5v8.9H248.4z" }),
                    React__default.createElement("path", { fill: textColor, d: "M282.7,31.2h10v41.9h-10V31.2z" }),
                    React__default.createElement("path", { fill: textColor, d: "M314,56.6c-5.6,0-9.8-1.8-12.6-5.4c-1.7-2.1-2.5-4.6-2.5-7.3c0-3.7,1.4-6.7,4.1-9.1s6.4-3.6,10.9-3.6h28.5     l-2.7,8.9h-25.7c-2.1,0-3.6,0.8-4.3,2.4c-0.2,0.5-0.3,1-0.3,1.5c0,1.5,0.7,2.6,2.2,3.3c0.7,0.3,1.5,0.5,2.4,0.5h14.4     c5.4,0,9.5,1.7,12.2,5.2c1.8,2.2,2.6,4.7,2.6,7.5c0,3.7-1.4,6.7-4.1,9.1c-2.7,2.4-6.3,3.6-10.8,3.6H299l2.7-8.9h26.8     c2.2,0,3.6-0.8,4.3-2.3c0.2-0.5,0.3-0.9,0.3-1.4c0-1.5-0.7-2.6-2.1-3.3c-0.7-0.4-1.6-0.5-2.5-0.5H314z" }),
                    React__default.createElement("path", { fill: textColor, d: "M358.8,74.2l-13.2-43h10.5l8,30.3l11.8-30.3h6.1l11.8,30.3l8-30.3h10.5l-13.6,40.3l-10,2.7l-9.8-26.6     l-10.1,23.9L358.8,74.2z" }),
                    React__default.createElement("path", { fill: textColor, d: "M424.1,67.6l3.6-8.5h11.7l-8.2-17.4l-14.6,31.5h-10.5L426,32.9l10-2.7l20.6,43h-10.5l-2.6-5.6H424.1z" }),
                    React__default.createElement("path", { fill: textColor, d: "M459.7,46.3l10-2.7V51h19.5c2,0,3.3-1,4.1-3c0.3-0.8,0.5-1.7,0.5-2.5c0-2.1-0.7-3.7-2.2-4.7     c-0.7-0.5-1.5-0.7-2.4-0.7h-29.5l2.7-8.9h26.4c5.4,0,9.5,1.9,12.5,5.7c2,2.7,3.1,5.7,3.1,9.1c0,4.1-1.5,7.5-4.4,10.1     c-2.8,2.5-6.6,3.8-11.2,3.8h-19.1v13.2h-10V46.3z" }))))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://defiswap.app/swap?outputCurrency=0x6f4217e1eF964D24e2F700E86Cb28ec81cAD5205", target: "_blank" },
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://defiswap.app/swap?outputCurrency=0x6f4217e1eF964D24e2F700E86Cb28ec81cAD5205", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
